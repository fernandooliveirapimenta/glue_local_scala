...
echo ("Criando os schemas spectrum ...");

create external schema spectrum_assistencia_ultron from data catalog database 'data_lake_ultron_assistencia' region 'us-east-1' iam_role 'arn:aws:iam::533865883733:role/Brasilseg-RedshiftS3Role'; 
create external schema spectrum_apolice_ultron from data catalog database 'data_lake_ultron_apolice' region 'us-east-1' iam_role 'arn:aws:iam::533865883733:role/Brasilseg-RedshiftS3Role'; 
create external schema spectrum_sinistro_ultron from data catalog database 'data_lake_ultron_sinistro' region 'us-east-1' iam_role 'arn:aws:iam::533865883733:role/Brasilseg-RedshiftS3Role'; 
create external schema spectrum_cliente_ultron from data catalog database 'data_lake_ultron_cliente' region 'us-east-1' iam_role 'arn:aws:iam::533865883733:role/Brasilseg-RedshiftS3Role'; 
create external schema spectrum_governanca_ultron from data catalog database 'data_lake_ultron_governanca' region 'us-east-1' iam_role 'arn:aws:iam::533865883733:role/Brasilseg-RedshiftS3Role'; 
create external schema spectrum_produto_ultron from data catalog database 'data_lake_ultron_produto' region 'us-east-1' iam_role 'arn:aws:iam::533865883733:role/Brasilseg-RedshiftS3Role'; 
...
grant usage on schema spectrum_governanca_ultron to group data_readers; 
...
grant select on all tables in schema spectrum_governanca_ultron to group data_readers; 
...
alter default privileges in schema spectrum_governanca_ultron grant select on tables to group data_reader; 
