...
echo 'movendo estrutura_tabela/bb30'
aws s3 cp /Users/fernandopimenta/Documents/git/scripts/estrutura_tabela/bb30/estrutura_assistencia_ultron.json  s3://datalake-glue-scripts-dev/estrutura_tabela/bb30/ --profile dev
