...
if __name__ == "__main__":
    ...
    for file in files:
        ...
        if 'dt_inclusao' not in df.columns and "DT_INCLUSAO" not in df.columns:
            df = df.withColumn('dt_inclusao', to_date(lit('01.01.1900'),'dd.MM.yyyy'))
        ...
        df.write.partitionBy("Ano", "Mes") \
            .mode("append") \
            .parquet("s3://{}/{}/{}/{}".format(targetBucketName, ambiente, base, tabela.lower()))
