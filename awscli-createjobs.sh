...
#bb30_carga_assistencia_redis_ultron_historico
    ...
    aws glue create-job \
        ...
        --default-arguments '{
            ...
            "--redshift_key_path": "s3://dev-brasilseg-segbr-extracao/chaves-redis/assistencia_ultron/assistencia",
...
#bb30_carga_assistencia_redis_ultron_historico
    ...
    aws glue create-job \
        ...
        --default-arguments '{
            ...
            "--redshift_schema": "spectrum_assistencia_ultron",
            "--schema":"estrutura_assistencia_ultron.json",
            "--redshift_key_path": "s3://hml-brasilseg-segbr-extracao/chaves-redis/assistencia_ultron/assistencia",
            "--queries":"AssistenciaUltronQuerys.json",
...
# PRD scala
    ...
    aws glue create-job \
        ...
        --default-arguments '{
            ...
            "--redshift_schema": "spectrum_assistencia_ultron",
            "--schema":"estrutura_assistencia_ultron.json",
            "--redshift_key_path": "s3://brasilseg-segbr-extracao/chaves-redis/assistencia_ultron/assistencia",
            "--queries":"AssistenciaUltronQuerys.json",
